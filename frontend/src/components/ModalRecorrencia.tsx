        ...
        <div className="shrink-0 p-5 border-b border-border flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Configure uma transação que se repete automaticamente</p>
            </div>
          </div>
        ...
        <div className="shrink-0 p-4 border-t border-border bg-card/95 flex flex-col-reverse sm:flex-row gap-2.5 justify-end">
          ...
          >
            {submetendo ? (
              ...
              <><FloppyDisk size={14} weight="bold" /><span>{recorrencia ? 'Salvar Alterações' : 'Criar Recorrência'}</span></>
            )}
          </button>
        </div>
      </div>
